    ...
    <section className="flex min-h-0 flex-col border-r border-slate-800">
      ...
      <div className="border-t border-slate-800 p-3">
        <div className="flex items-center gap-2">
          ...
          />
          {/* Mic button — wired to the voice pipeline (mic → STT → agent → TTS). */}
          <button
            title="Voice input"
            disabled
            className="grid h-9 w-9 shrink-0 place-items-center rounded-lg border border-slate-700 text-slate-500"
          >
            🎤
          </button>
          <button
